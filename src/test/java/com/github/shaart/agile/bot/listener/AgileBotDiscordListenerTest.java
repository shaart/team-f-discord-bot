...
import com.github.shaart.agile.bot.mapper.impl.AuthorMapper;
import com.github.shaart.agile.bot.mapper.impl.ChannelMapper;
import com.github.shaart.agile.bot.mapper.impl.EventMapper;
import com.github.shaart.agile.bot.mapper.impl.MessageMapper;
...
class AgileBotDiscordListenerTest {
...
//        .thenCallRealMethod();
  ...
  void onMessageReceivedWithUnexpectedErrorOnRun() {
    ...
    final Logger logger = (Logger) LoggerFactory.getLogger(AgileBotDiscordListener.class);
