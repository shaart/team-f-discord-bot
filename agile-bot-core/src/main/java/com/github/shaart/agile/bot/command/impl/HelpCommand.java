...
import static com.github.shaart.agile.bot.service.CommandService.DEFAULT_PAGE_NUMBER;
...
public class HelpCommand extends AbstractBotCommand {
  ...
  @Autowired
  public HelpCommand(AgileBotDiscordProperties properties, MessageSender messageSender) {
